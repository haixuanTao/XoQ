  ...
  return {
    ...
    armPairs: [
      { id: "pair2", enabled: true, label: "baguette Arm",
        ...
        queryRate: 100, autoQuery: true },
      { id: "pair3", enabled: true, label: "baguette Fake Arm",
        leftPath: "anon/7e58263812ba/xoq-can-can0-test", rightPath: "anon/7e58263812ba/xoq-can-can1-test",
        position: {x:1,y:0,z:1}, rotation: {roll:0,pitch:0,yaw:0},
        queryRate: 100, autoQuery: false },
      { id: "pair4", enabled: true, label: "champagne Arm",
        leftPath: "anon/a13af1d39199/xoq-can-can0", rightPath: "anon/a13af1d39199/xoq-can-can1",
        position: {x:2,y:0,z:1.98}, rotation: {roll:0,pitch:0,yaw:0},
        queryRate: 100, autoQuery: true },
      { id: "pair5", enabled: true, label: "champagne Fake Arm",
        leftPath: "anon/a13af1d39199/xoq-can-can0-test", rightPath: "anon/a13af1d39199/xoq-can-can1-test",
        position: {x:3,y:0,z:3}, rotation: {roll:0,pitch:0,yaw:0},
        queryRate: 100, autoQuery: false },
    ],
    cameras: [],
    realsense: [
      { id: "rs1", enabled: true, label: "baguette RealSense",
        path: "anon/7e58263812ba/realsense-243222073892",
        position: {x:-0.33,y:0.84,z:0.29}, rotation: {roll:90,pitch:-45,yaw:0},
        showColor: true, pointSize: 2 },
      { id: "rs2", enabled: true, label: "champagne RealSense",
        path: "anon/a13af1d39199/realsense-233522074606",
        position: {x:1.66,y:0.84,z:2.33}, rotation: {roll:90,pitch:-45,yaw:0},
        showColor: true, pointSize: 2 },
    ],
    audio: { enabled: true, path: "anon/openarm-audio" },
    chat: { enabled: true, path: "anon/openarm-chat", username: "reda" },
  };
}
